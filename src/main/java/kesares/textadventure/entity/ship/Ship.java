...
public class Ship {
    ...
    public Ship(Builder builder) {
        ...
        this.harpoons = builder.harpoons;
        this.goldCosts = builder.goldCosts;
        this.diamondCosts = builder.diamondCosts;
    }
    ...
    public static class Builder {
        ...
        public static Ship copyOf(Ship ship) {
            return new Builder().hp(ship.hp).cannons(ship.cannons).harpoons(ship.harpoons).goldCosts(ship.goldCosts)
        ...
        public Builder harpoons(int harpoons) {
        ...
        public Builder goldCosts(int goldCosts) {
        ...
        public Builder diamondCosts(int diamondCosts) {
